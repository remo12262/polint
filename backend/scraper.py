...
NEWS_SOURCES = [
    ...
    "https://feeds.feedburner.com/euobserver",
    "https://www.ansa.it/sito/notizie/politica/politica_rss.xml",
    "https://www.repubblica.it/rss/politica/rss2.0.xml",
    "https://www.corriere.it/rss/politica.xml",
    "https://feeds.feedburner.com/bruegel",
]

KEYWORDS = [
    "lobbying", "finanziamento", "partito", "coalizione", "influenza",
    "think tank", "fondazione", "donazione", "appalto", "nomine",
    "revolving door", "conflitto interessi", "parlamentare", "commissione",
    "AI Act", "NIS2", "DORA", "regolamento", "direttiva",
    "Meloni", "Schlein", "Tajani", "Salvini", "Von der Leyen",
    "Ursula", "Macron", "Scholz", "geopolitica", "NATO", "BRICS",
]
